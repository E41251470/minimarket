...
<head>
    ...
    <link href="{{ asset('asset/admin/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
    <link
...
<body id="page-top">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button href="{{ route('login') }}" class="btn btn-primary" type="button">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="{{ asset('asset/admin/img/undraw_posting_photo.svg') }}" alt="...">
                                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('login') }}" class="btn btn-primary" href="login.html">Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('asset/admin/vendor/chart.js/Chart.bundle.min.js') }}"></script>
